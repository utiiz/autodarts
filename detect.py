...
def process_frame(frame, line1_y, line2_y, line3_y):
    global dart_trajectories, previous_contour_count, detection_changed, change_timer
...
while True:
    ...
    visual_frame_resized = cv2.resize(visual_frame, (640, 360))
    motion_mask_resized = cv2.resize(motion_mask, (640, 360))

    # Concatenate frames horizontally
    combined_view = np.hstack((visual_frame_resized, motion_mask_resized))
