...
class DartManager:
    def __init__(self, dartboard, debug=False):
        self.dart = None
    ...
    def update(self):
        detector1 = DartDetector(
            ...
            dartboard_line=347, debug=self.debug)
        detector2 = DartDetector(
            video_source='./videos/CAM_02_03.mp4',
            dartboard_line=330, debug=self.debug)
...
def main():
    dartboard = Dartboard()
    dart_manager = DartManager(dartboard=dartboard)
