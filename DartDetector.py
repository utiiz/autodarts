...
class DartDetector:
    def __init__(self, video_source=0, dartboard_line=370, debug=False):
        """
...
def main():
    ...
    frame_differ = DartDetector(
        video_source='./videos/CAM_02_01.mp4', dartboard_line=330)

    # Process frames in a loop
    while True:
        frame_differ.process_frame()
        if frame_differ.dart is not None:
            print(f"X: {frame_differ.dart.x}, Angle: {frame_differ.dart.angle}")
